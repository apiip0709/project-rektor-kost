        ...
        <div class="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm">
            ...
            <form action="{{ route('superadmin.owner.store') }}" method="POST" class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {{-- ID User & Nama (Readonly) --}}
                    <div>
                        <label class="block text-sm font-bold text-slate-700 mb-1">ID User</label>
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email', $user->email) }}"
                            ...
                            {{ $user->register_method !== 'whatsapp' ? 'bg-slate-50 text-slate-500 cursor-not-allowed' : '' }}"
