        ...
        document.getElementById('file-input').addEventListener('change', function() {
            ...
            Array.from(this.files).forEach(file => {
                ...
                reader.onload = (e) => {
                    ...
                    div.innerHTML =
                        `<img src="${e.target.result}" class="w-full h-20 object-cover rounded-xl border"><button type="button" class="absolute -top-1 -right-1 bg-red-500 text-white rounded-full w-4 h-4 flex items-center justify-center text-[8px]" onclick="this.parentElement.remove()">x</button>`;
